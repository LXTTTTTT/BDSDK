...
//            ViewModelProvider.AndroidViewModelFactory.getInstance(application).create(argument[1] as Class<VM>)  // 使用全局 ViewModel
//            ViewModelProvider(this, ApplicationUtils.getGlobalFactory()).get(argument[1] as Class<VM>)
        else
